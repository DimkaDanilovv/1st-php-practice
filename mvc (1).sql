...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 20 2024 г., 17:20
...
INSERT INTO `users` (`id`, `login`, `password`, `link_to_the_role`, `name`, `surname`, `patronymic`, `gender`, `date`, `visa`, `subdivision`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
